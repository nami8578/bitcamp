...
<link rel="stylesheet" href="/member/css/memberSearch.css">
</head>
<body>
    <c:choose>
    ...
    <div class="container">
      <c:choose>
        ...
        <div class="content">
            <form action="/member/memberSearch" method="post" class="search" name="formID" target="_blank">
                <div class="title">
                    <h2>아이디 찾기</h2>
                </div>
                <div class="feild">
            ...
            <form action="SearchIDPW" class="search" name="formPW" target="_blank">
                <div class="title">
                    <h2>비밀번호 찾기</h2>
                </div>
                <div class="feild">
